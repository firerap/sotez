...
const textEncode = (value) => new Uint8Array(Buffer.from(value, 'utf8'));
 ...
 */
const mutez = (tez) => new BigNumber(new BigNumber(tez).toFixed(6)).multipliedBy(1000000).toString();
/**
